...
if (isset($_POST['btnapprove'])) {
  ...
  $sql = "UPDATE `payment` SET reservation_fee='$reservation_fee', payment_status='$payment_status', remaining_balance='$remaining_balance'
...
$mail->setFrom('uresu0350@gmail.com', 'BRORS');
...
// UPDATE PAYMENT //
if (isset($_POST['btnpaymentupdate'])) {
  ...
  $new_balance = $remaining_balance - $payment;

  $sql = "UPDATE `payment` SET payment_status='$payment_status', second_payment='$second_payment'
  , reservation_fee='$total_bills', remaining_balance='$new_balance'
 WHERE payment_id='$payment_id'";
...
// INVALID RESERVATION //
if (isset($_POST['btnreservationinvalid'])) {
...
if ($conn->query($sql) === TRUE) {
  ...
  $sql1 = "UPDATE `payment` SET payment_status='$payment_status'
  WHERE reservation_id='$reservation_id'";
