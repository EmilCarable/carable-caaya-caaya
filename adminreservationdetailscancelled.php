...
background: radial-gradient(circle, rgba(0,228,255,1) 0%, rgba(0,130,188,1) 50%);
        ...
        <div class="panel-heading">
          ...
          <p style="margin-bottom: 0%; font-weight:bold;">
            ...
            <a href="adminreceipt.php?reservation_id=<?php echo htmlspecialchars($reservation_id); ?>" class="btn btn-success" data-toggle="tooltip" title="PRINT RECEIPT">
