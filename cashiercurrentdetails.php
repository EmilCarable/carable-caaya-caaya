...
background: radial-gradient(circle, rgba(0,228,255,1) 0%, rgba(0,130,188,1) 50%);
        ...
        <div class="panel-heading">
          ...
          <p style="margin-bottom: 0%; font-weight:bold;">
            ...
            <a href="cashierreceipt.php?reservation_id=<?php echo htmlspecialchars($reservation_id); ?>" class="btn btn-success" data-toggle="tooltip" title="PRINT RECEIPT">
              <span class="glyphicon glyphicon-print"></span>
            </a>

            <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#myModalUpdate">
 ...
 ");
            ...
            <div class="col-xs-6">
              ...
              ?>
                ...
                <!-- //////////////////////////////////////// payment update //////////////////////////////////////// -->
                <div id="myModalUpdate" class="modal fade" role="dialog"><!-- ///// modal ///// -->
...
background: radial-gradient(circle, rgba(0,228,255,1) 0%, rgba(0,130,188,1) 50%);">
                      ...
                      <div class="modal-body"><!-- ///// body ///// -->
                        ...
                        <!-- ####################################### FORM ############################################ -->
                        <form class="form-horizontal" action="cashierreservationsql.php?payment_id=<?php echo $payment_id; ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-4">
                                ...
                                <input type="number" class="form-control text-center " id="payment" name="payment" min="0" placeholder="Enter Amount" required>
                                <!-- amount--> <br>
                                ...
                                <div class="btn-group">
                                  <button type="submit" class="btn btn-success" id="btnpaymentupdate" name="btnpaymentupdate">Update Payment</button>
...
background: radial-gradient(circle, rgba(0,228,255,1) 0%, rgba(0,130,188,1) 50%);
        box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); font-weight:bold;">
                ...
                <div class="alert-success">
                  GCASH Ref No.: <?php echo htmlspecialchars($second_payment); ?>
                </div>
                <p style="font-size: small; font-weight:bold; text-align:left;
background: rgb(0,228,255);
background: radial-gradient(circle, rgba(0,228,255,1) 0%, rgba(0,130,188,1) 50%);
