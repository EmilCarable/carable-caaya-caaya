...
payment.remaining_balance
  ...
  WHERE reservation_status='Pending' ORDER BY reservation_id DESC
 ");
$stmt->execute();
...
while ($stmt->fetch()) {
  ...
  // Display the data securely
    ?>
      ...
      <img src="<?php echo htmlspecialchars($first_payment); ?>" class="img-rounded" width="50px" height="50px">
  ...
  <a href="#">
     <?php echo htmlspecialchars($mobile_number); ?>
      ...
      <div class="btn-group-vertical">
			<a href="adminreservationdetailspending.php?reservation_id=<?php echo htmlspecialchars($reservation_id); ?>" 
