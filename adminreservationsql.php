...
// APPROVE RESERVATION //
if (isset($_POST['btnreservationapprove'])) {
...
$message = "<h3>"."Dear Valued Customer,<br>This is to give an update of your reservation to Benilda's Resort Online Reservation. Your reservation has been successfully booked. 
Thank you for trusting us. We're happy to serve you.
...
$mail->Password = 'xvcbyexpralnodvt';  // Your Gmail password
